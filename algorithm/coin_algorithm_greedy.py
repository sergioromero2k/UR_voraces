#!/usr/bin/env python3
"""
# Other form Greedy Coin Change Algorithm
...
def money_exchange(value, coins) -> list:
    """ Greedy Coin Change Algorithm
    
        The algorithm has an approximate time complexity of O(n),
        where n is the number of coin types.
    """
